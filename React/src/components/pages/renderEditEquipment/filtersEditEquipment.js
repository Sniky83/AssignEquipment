...
import { GetEquipmentsFilters } from "../../../services/editEquipment/editEquipmentService";

export default function FiltersEditEquipment(props) {
    const onSubmit = async (event) => {
        event.preventDefault();

        const response = await GetEquipmentsFilters();
            ...
            <Form id="filter" onSubmit={event => onSubmit(event)}>
                <Form.Group className="row mb-auto mt-3">
                    ...
                    <div className="col-md-3">
                        <Form.Control type="input" name="keyword" maxLength="25" placeholder="Type, Marque, Modèle" />
                    </div>
